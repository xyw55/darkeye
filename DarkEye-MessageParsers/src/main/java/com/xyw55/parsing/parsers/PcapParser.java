package com.xyw55.parsing.parsers;

import com.xyw55.pacp.Constants;
import com.xyw55.pacp.OpenSocEthernetDecoder;
import com.xyw55.pacp.PacketInfo;
import com.xyw55.pacp.PcapByteInputStream;
...
public final class PcapParser {
    ...
    */
    ...
    File fin = new File("/Users/xiayiwei/Documents/finalPaper/code/darkeye/DarkEye-Topology/src/main/resources/SampleInput/pcap7.pcap");
    ...
    for (int i = 0; i < totalIterations; i++) {
        ...
        for (PacketInfo packetInfo : list) {
            ...
            if (packetInfo.getTcpPacket() != null) {
                if (packetInfo.getTcpPacket().getData() != null) {
                    System.out.println(packetInfo.getJsonDoc());

                    ChainBuffer data = (ChainBuffer) packetInfo.getTcpPacket().getData();
                    byte[] buffer = new byte[data.readableBytes()];
                    data.gets(buffer, 0 , data.readableBytes());
