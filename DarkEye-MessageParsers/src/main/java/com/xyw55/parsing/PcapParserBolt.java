...
import com.xyw55.parsing.parsers.PcapParser;
...
public class PcapParserBolt implements IRichBolt {
  ...
  public void declareOutputFields(OutputFieldsDeclarer declarer) {
    ...
    declarer.declareStream("pcap_body_stream", new Fields("pcap_id", "timestamp", "body"));
  ...
  public void execute(Tuple input) {
    ...
    try {
      System.out.println("start parser " + input);
...
//                System.out.println(new String(buffer));
                ...
                body.put("body", data);
                collector.emit("pcap_body_stream", new Values(packetInfo.getKey(),
